...
NEXTFLOW_BIN="/lustre09/project/6008022/LAB_WORKSPACE/SOFTWARE/bioutils/bin/nextflow-25.10.2-dist"
...
SAREK_DIR="/lustre09/project/6008022/LAB_WORKSPACE/SOFTWARE/Git_pipeline/SAREK-CNV-ShortVariants/sarek-3.8.1-offline/3_8_1"

# --- iGenomes / reference base (pre-downloaded, offline) --------------------
IGENOMES_BASE="/lustre09/project/6008022/LAB_WORKSPACE/SOFTWARE/Git_pipeline/SAREK-CNV-ShortVariants/sarek-resource-offline/references"
GENOME="GATK.GRCh38"
...
export NXF_SINGULARITY_CACHEDIR="/lustre09/project/6008022/LAB_WORKSPACE/SOFTWARE/Git_pipeline/SAREK-CNV-ShortVariants/sarek-resource-offline/NXF_SINGULARITY_CACHEDIR"
...
export APPTAINER_TMPDIR="/lustre09/project/6008022/LAB_WORKSPACE/SOFTWARE/Git_pipeline/SAREK-CNV-ShortVariants/sarek-resource-offline/apptainer_tmp"
