...
SAREK_DIR="/home/flben/work_projects/SAREK-CNV-ShortVariants/sarek-3.8.1-offline/3_8_1"

# --- iGenomes / reference base (pre-downloaded, offline) --------------------
IGENOMES_BASE="/home/flben/work_projects/SAREK-CNV-ShortVariants/sarek-resource-offline/references"
GENOME="GATK.GRCh38"
...
export NXF_SINGULARITY_CACHEDIR="/home/flben/work_projects/SAREK-CNV-ShortVariants/sarek-resource-offline/NXF_SINGULARITY_CACHEDIR"
...
export APPTAINER_TMPDIR="/home/flben/work_projects/SAREK-CNV-ShortVariants/sarek-resource-offline/apptainer_tmp"
